        ...
        {conversations.map((c) => (
          ...
          >
            ...
            <button
              ...
              className="shrink-0 p-1.5 rounded-md text-[var(--color-text-muted)] hover:text-[var(--color-error-text)] hover:bg-[var(--color-error-bg)] opacity-0 group-hover:opacity-100 transition-opacity border-none cursor-pointer"
            >
