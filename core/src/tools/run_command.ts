...
export const run_command = tool(
  ...
  },
  {
    ...
    schema: z.object({
      ...
      timeout_ms: z.number().optional().nullable().describe("Max execution time in milliseconds (default 600000, max 600000 = 10 minutes)"),
      working_directory: z.string().optional().nullable().describe("Working directory for the command (defaults to server cwd)"),
    }),
  }
);
