...
export const read_file = tool(
  ...
  },
  {
    ...
    schema: z.object({
      ...
      offset: z.number().optional().nullable().describe("Start reading from this line number (1-based, default 1)"),
      limit: z.number().optional().nullable().describe("Max number of lines to return"),
    }),
  }
);
