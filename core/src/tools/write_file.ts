...
export const write_file = tool(
  ...
  },
  {
    ...
    schema: z.object({
      ...
      content: z.string().optional().nullable().describe("The text content to write. Use content_base64 for large or HTML/CSS to avoid escaping issues."),
      content_base64: z.string().optional().nullable().describe("Base64-encoded content. Prefer this for large HTML/CSS/XML to avoid JSON quote escaping."),
      append: z.boolean().optional().nullable().describe("If true, append to the file instead of overwriting (default: false)"),
    }),
  }
);
