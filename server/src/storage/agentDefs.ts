...
- Identify risks, edge cases, and suggest which role should handle each subtask.`,
    allowedTools: ["read_file", "search_code", "list_files", "load_skill", "background_run", "background_check", "background_cancel", "web_search"],
    builtIn: true,
  },
  {
    id: "coder",
...
- If NEEDS_FIX, list required changes as numbered bullet points with severity (critical/major/minor).`,
    allowedTools: ["read_file", "search_code", "list_files", "git_operations", "load_skill", "background_run", "background_check", "background_cancel", "web_search"],
    builtIn: true,
  },
  {
    id: "tester",
