...
export const test_runner = tool(
  ...
  },
  {
    ...
    schema: z.object({
      path: z.string().optional().describe("Test file or directory (auto-detects framework if omitted)"),
      framework: z.enum(["auto", "jest", "vitest", "pytest", "mocha", "cargo_test", "go_test"]).optional()
